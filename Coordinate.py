# -*- coding: utf-8 -*-
"""
Created on Sun Apr 26 20:02:06 2020
...
cv2.imwrite('tempImage1.png', cv2.cvtColor(color, cv2.COLOR_RGB2BGR))
...
coordinates[2] = zFinal  

print(coordinates)
sio.savemat('coordinates.mat', {"dict":coordinates})

print(x_pixel_from_center,y_pixel_from_center,x_center_pixel,y_center_pixel)